...
// does not run in Expo Go. API verified against the installed package's own
// TypeScript definitions (node_modules/@maplibre/maplibre-react-native), not
// just docs, since this component cannot be exercised in this sandbox.
